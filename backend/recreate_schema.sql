...
VALUES ('org-super-admin', 'Super Admin', 'super_admin', NULL, 'user-super-admin', 100000.0, 'active', unixepoch(), unixepoch());

-- Insert Super Admin User (password: admin123)
INSERT INTO users (id, email, password, role, organization_id, created_at, updated_at)
VALUES ('user-super-admin', 'admin@voipplatform.com', 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855', 'super_admin', 'org-super-admin', unixepoch(), unixepoch());
...
VALUES ('user-super-admin', 'Platform Administrator', 1, 1, 1, 1, 1, unixepoch(), unixepoch());
...
SELECT 'Login: admin@voipplatform.com / admin123' as super_admin;
SELECT 'Login: john@techcom.com / admin123' as agency_admin;
SELECT 'Login: sarah@acmecorp.com / admin123' as business_admin;
